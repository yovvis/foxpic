...
import com.ayfox.web.model.dto.space.*;
import com.ayfox.web.model.entity.Space;
import com.ayfox.web.model.entity.User;
import com.ayfox.web.model.enums.SpaceLevelEnum;
...
@Tag(name = "SpaceController", description = "空间接口")
@RestController
...
public class SpaceController {
     ...
     */
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    @Operation(summary = "根据 id 获取空间（仅管理员可用）")
    @GetMapping("/get")
     ...
     * 根据 id 获取空间（封装类）
     */
    @Operation(summary = "根据 id 获取空间（封装类）")
    @GetMapping("/get/vo")
     ...
     */
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    @Operation(summary = "分页获取空间列表（仅管理员可用）")
     ...
     * 分页获取空间列表（封装类）
     */
    @Operation(summary = "分页获取空间列表（封装类）")
     ...
     * @return
     */
    @Operation(summary = "获取空间级别列表，便于前端展示")
